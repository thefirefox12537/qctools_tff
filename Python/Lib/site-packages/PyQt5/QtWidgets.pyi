...
class QAbstractItemView(QAbstractScrollArea):
    ...
    class EditTriggers(PyQt5.sip.simplewrapper):
...
class QAbstractSpinBox(QWidget):
    ...
    class StepEnabled(PyQt5.sip.simplewrapper):
...
class QColorDialog(QDialog):
    ...
    class ColorDialogOptions(PyQt5.sip.simplewrapper):
...
class QStyle(QtCore.QObject):
    ...
    class State(PyQt5.sip.simplewrapper):
    ...
    class SubControls(PyQt5.sip.simplewrapper):
...
class QDateTimeEdit(QAbstractSpinBox):
    ...
    class Sections(PyQt5.sip.simplewrapper):
...
class QDialogButtonBox(QWidget):
    ...
    class StandardButtons(PyQt5.sip.simplewrapper):
...
class QDockWidget(QWidget):
    ...
    class DockWidgetFeatures(PyQt5.sip.simplewrapper):
...
class QFileDialog(QDialog):
    ...
    class Options(PyQt5.sip.simplewrapper):
...
class QFileIconProvider(PyQt5.sip.simplewrapper):
...
class QFontComboBox(QComboBox):
    ...
    class FontFilters(PyQt5.sip.simplewrapper):
...
class QFontDialog(QDialog):
    ...
    class FontDialogOptions(PyQt5.sip.simplewrapper):
...
class QFormLayout(QLayout):
    ...
    class TakeRowResult(PyQt5.sip.simplewrapper):
...
class QPinchGesture(QGesture):
    ...
    class ChangeFlags(PyQt5.sip.simplewrapper):
...
class QGestureRecognizer(PyQt5.sip.wrapper):
    ...
    class Result(PyQt5.sip.simplewrapper):
...
class QGraphicsBlurEffect(QGraphicsEffect):
    ...
    class BlurHints(PyQt5.sip.simplewrapper):
...
class QGraphicsItem(PyQt5.sip.wrapper):
    ...
    class GraphicsItemFlags(PyQt5.sip.simplewrapper):
...
class QGraphicsScene(QtCore.QObject):
    ...
    class SceneLayers(PyQt5.sip.simplewrapper):
...
class QGraphicsView(QAbstractScrollArea):
    ...
    class CacheMode(PyQt5.sip.simplewrapper):
    ...
    class OptimizationFlags(PyQt5.sip.simplewrapper):
...
class QInputDialog(QDialog):
    ...
    class InputDialogOptions(PyQt5.sip.simplewrapper):
...
class QMainWindow(QWidget):
    ...
    class DockOptions(PyQt5.sip.simplewrapper):
...
class QMdiArea(QAbstractScrollArea):
    ...
    class AreaOptions(PyQt5.sip.simplewrapper):
...
class QMdiSubWindow(QWidget):
    ...
    class SubWindowOptions(PyQt5.sip.simplewrapper):
...
class QScrollerProperties(PyQt5.sip.simplewrapper):
...
class QSizePolicy(PyQt5.sip.simplewrapper):
    ...
    class ControlTypes(PyQt5.sip.simplewrapper):
...
class QStyleFactory(PyQt5.sip.simplewrapper):
...
class QStyleOption(PyQt5.sip.simplewrapper):
...
class QStyleOptionFrame(QStyleOption):
    ...
    class FrameFeatures(PyQt5.sip.simplewrapper):
...
class QStyleOptionButton(QStyleOption):
    ...
    class ButtonFeatures(PyQt5.sip.simplewrapper):
...
class QStyleOptionTab(QStyleOption):
    ...
    class CornerWidgets(PyQt5.sip.simplewrapper):
    ...
    class TabFeatures(PyQt5.sip.simplewrapper):
...
class QStyleOptionViewItem(QStyleOption):
    ...
    class ViewItemFeatures(PyQt5.sip.simplewrapper):
...
class QStyleOptionToolButton(QStyleOptionComplex):
    ...
    class ToolButtonFeatures(PyQt5.sip.simplewrapper):
...
class QStyleHintReturn(PyQt5.sip.simplewrapper):
...
class QStyleOptionToolBar(QStyleOption):
    ...
    class ToolBarFeatures(PyQt5.sip.simplewrapper):
...
class QTableWidgetSelectionRange(PyQt5.sip.simplewrapper):
...
class QTextEdit(QAbstractScrollArea):
    ...
    class ExtraSelection(PyQt5.sip.simplewrapper):
    ...
    class AutoFormatting(PyQt5.sip.simplewrapper):
...
class QToolTip(PyQt5.sip.simplewrapper):
...
class QTreeWidgetItemIterator(PyQt5.sip.simplewrapper):
...
class QWhatsThis(PyQt5.sip.simplewrapper):
...
class QWizard(QDialog):
    ...
    class WizardOptions(PyQt5.sip.simplewrapper):
