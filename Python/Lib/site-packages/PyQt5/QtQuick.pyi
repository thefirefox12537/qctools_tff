...
class QQuickItem(QtCore.QObject, QtQml.QQmlParserStatus):
    ...
    class ItemChangeData(PyQt5.sip.simplewrapper):
    ...
    class UpdatePaintNodeData(PyQt5.sip.simplewrapper):
...
class QQuickPaintedItem(QQuickItem):
    ...
    class PerformanceHints(PyQt5.sip.simplewrapper):
...
class QQuickWindow(QtGui.QWindow):
    ...
    class CreateTextureOptions(PyQt5.sip.simplewrapper):
...
class QQuickCloseEvent(PyQt5.sip.simplewrapper): ...
...
class QSGAbstractRenderer(QtCore.QObject):
    ...
    class ClearMode(PyQt5.sip.simplewrapper):
    ...
    class MatrixTransformFlags(PyQt5.sip.simplewrapper):
...
class QSGGeometry(PyQt5.sip.wrapper):
    ...
    class AttributeSet(PyQt5.sip.simplewrapper):
    ...
    class Point2D(PyQt5.sip.simplewrapper):
    ...
    class TexturedPoint2D(PyQt5.sip.simplewrapper):
    ...
    class ColoredPoint2D(PyQt5.sip.simplewrapper):
...
class QSGNode(PyQt5.sip.wrapper):
    ...
    class DirtyState(PyQt5.sip.simplewrapper):
...
class QSGImageNode(QSGGeometryNode):
    ...
    class TextureCoordinatesTransformMode(PyQt5.sip.simplewrapper):
...
class QSGMaterialShader(PyQt5.sip.wrapper):
    ...
    class RenderState(PyQt5.sip.simplewrapper):
        ...
        class DirtyStates(PyQt5.sip.simplewrapper):
...
class QSGMaterialType(PyQt5.sip.simplewrapper):
...
class QSGMaterialRhiShader(QSGMaterialShader):
    ...
    class GraphicsPipelineState(PyQt5.sip.simplewrapper):
        ...
        class ColorMask(PyQt5.sip.simplewrapper):
...
class QSGRendererInterface(PyQt5.sip.simplewrapper):
    ...
    class ShaderCompilationTypes(PyQt5.sip.simplewrapper):
    ...
    class ShaderSourceTypes(PyQt5.sip.simplewrapper):
...
class QSGRenderNode(QSGNode):
    ...
    class RenderingFlags(PyQt5.sip.simplewrapper):
...
class QSGTexture(QtCore.QObject):
    ...
    class NativeTexture(PyQt5.sip.simplewrapper):
