...
class QNdefFilter(PyQt5.sip.simplewrapper):

    class Record(PyQt5.sip.simplewrapper):
...
class QNdefMessage(PyQt5.sip.simplewrapper):
...
class QNdefRecord(PyQt5.sip.simplewrapper):
...
class QNearFieldManager(QtCore.QObject):
    ...
    class TargetAccessModes(PyQt5.sip.simplewrapper):
...
class QNearFieldShareManager(QtCore.QObject):
    ...
    class ShareModes(PyQt5.sip.simplewrapper):
...
class QNearFieldTarget(QtCore.QObject):
    ...
    class AccessMethods(PyQt5.sip.simplewrapper):
    ...
    class RequestId(PyQt5.sip.simplewrapper):
