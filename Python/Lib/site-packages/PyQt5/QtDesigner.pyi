...
class QAbstractFormBuilder(PyQt5.sip.simplewrapper):
...
class QDesignerFormWindowInterface(QtWidgets.QWidget):
    ...
    class Feature(PyQt5.sip.simplewrapper):
...
class QDesignerFormWindowCursorInterface(PyQt5.sip.simplewrapper):
...
class QDesignerContainerExtension(PyQt5.sip.simplewrapper):
...
class QDesignerCustomWidgetInterface(PyQt5.sip.simplewrapper):
...
class QDesignerCustomWidgetCollectionInterface(PyQt5.sip.simplewrapper):
...
class QAbstractExtensionFactory(PyQt5.sip.simplewrapper):
...
class QAbstractExtensionManager(PyQt5.sip.simplewrapper):
...
class QDesignerMemberSheetExtension(PyQt5.sip.simplewrapper):
...
class QDesignerPropertySheetExtension(PyQt5.sip.simplewrapper):
...
class QDesignerTaskMenuExtension(PyQt5.sip.simplewrapper):
