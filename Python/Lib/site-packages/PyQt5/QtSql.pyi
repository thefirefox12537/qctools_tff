...
class QSqlDatabase(PyQt5.sip.simplewrapper):
...
class QSqlError(PyQt5.sip.simplewrapper):
...
class QSqlField(PyQt5.sip.simplewrapper):
...
class QSqlRecord(PyQt5.sip.simplewrapper):
...
class QSqlQuery(PyQt5.sip.simplewrapper):
...
class QSqlRelation(PyQt5.sip.simplewrapper):
...
class QSql(PyQt5.sip.simplewrapper):
    ...
    class ParamType(PyQt5.sip.simplewrapper):
