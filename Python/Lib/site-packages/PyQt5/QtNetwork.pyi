...
class QNetworkCacheMetaData(PyQt5.sip.simplewrapper):
...
class QAbstractSocket(QtCore.QIODevice):
    ...
    class BindMode(PyQt5.sip.simplewrapper):
    ...
    class PauseModes(PyQt5.sip.simplewrapper):
...
class QAuthenticator(PyQt5.sip.simplewrapper):
...
class QDnsDomainNameRecord(PyQt5.sip.simplewrapper):
...
class QDnsHostAddressRecord(PyQt5.sip.simplewrapper):
...
class QDnsMailExchangeRecord(PyQt5.sip.simplewrapper):
...
class QDnsServiceRecord(PyQt5.sip.simplewrapper):
...
class QDnsTextRecord(PyQt5.sip.simplewrapper):
...
class QHostAddress(PyQt5.sip.simplewrapper):
    ...
    class ConversionMode(PyQt5.sip.simplewrapper):
...
class QHostInfo(PyQt5.sip.simplewrapper):
...
class QHstsPolicy(PyQt5.sip.simplewrapper):

    class PolicyFlag(int):
        IncludeSubDomains = ... # type: QHstsPolicy.PolicyFlag

    class PolicyFlags(PyQt5.sip.simplewrapper):
...
class QHttp2Configuration(PyQt5.sip.simplewrapper):
...
class QHttpPart(PyQt5.sip.simplewrapper):
...
class QLocalServer(QtCore.QObject):
    ...
    class SocketOptions(PyQt5.sip.simplewrapper):
...
class QNetworkConfiguration(PyQt5.sip.simplewrapper):
    ...
    class StateFlags(PyQt5.sip.simplewrapper):
...
class QNetworkCookie(PyQt5.sip.simplewrapper):
...
class QNetworkDatagram(PyQt5.sip.simplewrapper):
...
class QNetworkAddressEntry(PyQt5.sip.simplewrapper):
...
class QNetworkInterface(PyQt5.sip.simplewrapper):
    ...
    class InterfaceFlags(PyQt5.sip.simplewrapper):
...
class QNetworkProxy(PyQt5.sip.simplewrapper):
...
class QNetworkProxyQuery(PyQt5.sip.simplewrapper):
...
class QNetworkRequest(PyQt5.sip.simplewrapper):
...
class QNetworkSession(QtCore.QObject):
    ...
    class UsagePolicies(PyQt5.sip.simplewrapper):
...
class QOcspResponse(PyQt5.sip.simplewrapper):
...
class QSsl(PyQt5.sip.simplewrapper):
    ...
    class SslOptions(PyQt5.sip.simplewrapper):
...
class QSslCertificate(PyQt5.sip.simplewrapper):
...
class QSslCertificateExtension(PyQt5.sip.simplewrapper):
...
class QSslCipher(PyQt5.sip.simplewrapper):
...
class QSslConfiguration(PyQt5.sip.simplewrapper):
...
class QSslDiffieHellmanParameters(PyQt5.sip.simplewrapper):
...
class QSslEllipticCurve(PyQt5.sip.simplewrapper):
...
class QSslError(PyQt5.sip.simplewrapper):
...
class QSslKey(PyQt5.sip.simplewrapper):
...
class QSslPreSharedKeyAuthenticator(PyQt5.sip.simplewrapper):
