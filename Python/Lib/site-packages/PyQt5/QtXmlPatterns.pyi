...
class QXmlNodeModelIndex(PyQt5.sip.simplewrapper):
...
class QAbstractXmlNodeModel(PyQt5.sip.simplewrapper):
...
class QXmlItem(PyQt5.sip.simplewrapper):
...
class QAbstractXmlReceiver(PyQt5.sip.simplewrapper):
...
class QSourceLocation(PyQt5.sip.simplewrapper):
...
class QXmlName(PyQt5.sip.simplewrapper):
...
class QXmlNamePool(PyQt5.sip.simplewrapper):
...
class QXmlQuery(PyQt5.sip.simplewrapper):
...
class QXmlResultItems(PyQt5.sip.simplewrapper):
...
class QXmlSchema(PyQt5.sip.simplewrapper):
...
class QXmlSchemaValidator(PyQt5.sip.simplewrapper):
