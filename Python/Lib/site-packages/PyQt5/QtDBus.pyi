...
class QDBusArgument(PyQt5.sip.simplewrapper):
...
class QDBusConnection(PyQt5.sip.simplewrapper):
...
class QDBusError(PyQt5.sip.simplewrapper):
...
class QDBusVariant(PyQt5.sip.simplewrapper):
...
class QDBusMessage(PyQt5.sip.simplewrapper):
...
class QDBusPendingCall(PyQt5.sip.simplewrapper):
...
class QDBusServiceWatcher(QtCore.QObject):
    ...
    class WatchMode(PyQt5.sip.simplewrapper):
...
class QDBusUnixFileDescriptor(PyQt5.sip.simplewrapper):
...
class QDBusReply(PyQt5.sip.simplewrapper):
