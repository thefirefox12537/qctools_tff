...
class QJSEngine(QtCore.QObject):
    ...
    class Extensions(PyQt5.sip.simplewrapper):
...
class QJSValue(PyQt5.sip.simplewrapper):
...
class QJSValueIterator(PyQt5.sip.simplewrapper):
...
class QQmlAbstractUrlInterceptor(PyQt5.sip.simplewrapper):
...
class QQmlContext(QtCore.QObject):
    ...
    class PropertyPair(PyQt5.sip.simplewrapper):
...
class QQmlError(PyQt5.sip.simplewrapper):
...
class QQmlIncubator(PyQt5.sip.simplewrapper):
...
class QQmlIncubationController(PyQt5.sip.simplewrapper):
...
class QQmlListReference(PyQt5.sip.simplewrapper):
...
class QQmlNetworkAccessManagerFactory(PyQt5.sip.simplewrapper):
...
class QQmlParserStatus(PyQt5.sip.simplewrapper):
...
class QQmlProperty(PyQt5.sip.simplewrapper):
...
class QQmlPropertyValueSource(PyQt5.sip.simplewrapper):
...
class QQmlScriptString(PyQt5.sip.simplewrapper):
