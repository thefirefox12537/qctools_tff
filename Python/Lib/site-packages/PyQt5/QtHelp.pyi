...
class QCompressedHelpInfo(PyQt5.sip.simplewrapper):
...
class QHelpContentItem(PyQt5.sip.simplewrapper):
...
class QHelpFilterData(PyQt5.sip.simplewrapper):
...
class QHelpLink(PyQt5.sip.simplewrapper):
...
class QHelpSearchQuery(PyQt5.sip.simplewrapper):
...
class QHelpSearchResult(PyQt5.sip.simplewrapper):
