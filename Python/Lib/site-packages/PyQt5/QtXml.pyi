...
class QDomImplementation(PyQt5.sip.simplewrapper):
...
class QDomNode(PyQt5.sip.simplewrapper):
...
class QDomNodeList(PyQt5.sip.simplewrapper):
...
class QDomNamedNodeMap(PyQt5.sip.simplewrapper):
...
class QXmlNamespaceSupport(PyQt5.sip.simplewrapper):
...
class QXmlAttributes(PyQt5.sip.simplewrapper):
...
class QXmlInputSource(PyQt5.sip.simplewrapper):
...
class QXmlParseException(PyQt5.sip.simplewrapper):
...
class QXmlReader(PyQt5.sip.simplewrapper):
...
class QXmlLocator(PyQt5.sip.simplewrapper):
...
class QXmlContentHandler(PyQt5.sip.simplewrapper):
...
class QXmlErrorHandler(PyQt5.sip.simplewrapper):
...
class QXmlDTDHandler(PyQt5.sip.simplewrapper):
...
class QXmlEntityResolver(PyQt5.sip.simplewrapper):
...
class QXmlLexicalHandler(PyQt5.sip.simplewrapper):
...
class QXmlDeclHandler(PyQt5.sip.simplewrapper):
